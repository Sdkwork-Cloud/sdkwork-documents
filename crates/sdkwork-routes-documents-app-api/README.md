...
This README is the SDKWork module entrypoint for `sdkwork-routes-documents-app-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test -p sdkwork-routes-documents-app-api`
