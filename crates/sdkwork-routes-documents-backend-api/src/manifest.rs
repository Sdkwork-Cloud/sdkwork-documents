pub const PACKAGE_NAME: &str = "sdkwork-routes-documents-backend-api";
...
pub const API_AUTHORITY: &str = "sdkwork-documents-backend-api";
pub const SDK_FAMILY: &str = "sdkwork-documents-backend-sdk";
...
pub const ROUTES: &[RouteManifestEntry] = &[
    ...
    RouteManifestEntry {
        method: "GET",
        path: "/backend/v3/api/documents/{documentId}",
