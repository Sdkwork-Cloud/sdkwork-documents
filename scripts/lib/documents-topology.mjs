...
export const IAM_APPLICATION_BOOTSTRAP_ENV = {
  ...
  SDKWORK_DOCUMENTS_APP_ROOT: REPO_ROOT,
};
...
export function resolveDefaultAppSdkBaseUrl(profileEnv = {}) {
  return (
    profileEnv.SDKWORK_DOCUMENTS_APPLICATION_PUBLIC_HTTP_URL
    ?? profileEnv.VITE_SDKWORK_DOCUMENTS_APPLICATION_PUBLIC_HTTP_URL
...
export function resolveDefaultBackendSdkBaseUrl(profileEnv = {}) {
  return (
    profileEnv.SDKWORK_DOCUMENTS_APPLICATION_BACKEND_HTTP_URL
    ?? profileEnv.VITE_SDKWORK_DOCUMENTS_APPLICATION_BACKEND_HTTP_URL
    ?? "http://127.0.0.1:18084"
  );
}
...
export function resolveDefaultOpenSdkBaseUrl(profileEnv = {}) {
  return (
    profileEnv.SDKWORK_DOCUMENTS_APPLICATION_OPEN_HTTP_URL
    ?? profileEnv.VITE_SDKWORK_DOCUMENTS_APPLICATION_OPEN_HTTP_URL
    ?? "http://127.0.0.1:18084"
  );
}
