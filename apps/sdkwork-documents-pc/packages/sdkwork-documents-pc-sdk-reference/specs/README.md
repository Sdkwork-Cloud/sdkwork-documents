# SDKWork Documents PC SDK Reference Component Specs

This directory is the local standards index for `sdkwork-documents-pc-sdk-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-documents-pc-sdk-reference` |
| Type | `node-package` |
| Root | `sdkwork-documents/apps/sdkwork-documents-pc/packages/sdkwork-documents-pc-sdk-reference` |
| Domain | `content` |
...
- `pnpm --filter @sdkwork/documents-pc-sdk-reference typecheck`
