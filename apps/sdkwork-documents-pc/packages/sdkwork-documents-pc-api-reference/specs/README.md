# SDKWork Documents PC API Reference Component Specs

This directory is the local standards index for `sdkwork-documents-pc-api-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-documents-pc-api-reference` |
| Type | `node-package` |
| Root | `sdkwork-documents/apps/sdkwork-documents-pc/packages/sdkwork-documents-pc-api-reference` |
| Domain | `content` |
...
- `.`
- `./openapiTypes`
- `./apiReferenceSchemaTabs`
- `./openapiSchemaRuntime`
...
- `pnpm --filter @sdkwork/documents-pc-api-reference typecheck`
