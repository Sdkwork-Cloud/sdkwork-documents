# sdkwork-documents Source Configuration
...
| `runtimeCode` | `documents` |
| Config root | `/etc/sdkwork/documents/` |
| Runtime TOML | `/etc/sdkwork/documents/config.toml` |
| Secrets | `/etc/sdkwork/documents/secrets/` |
| Override | `SDKWORK_DOCUMENTS_CONFIG_FILE` |
