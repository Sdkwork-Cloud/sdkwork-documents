...
```bash
npm install @sdkwork/documents-sdk
# or
yarn add @sdkwork/documents-sdk
# or
pnpm add @sdkwork/documents-sdk
```

## Quick Start

```typescript
import { SdkworkDocumentsOpenClient } from '@sdkwork/documents-sdk';

const client = new SdkworkDocumentsOpenClient({
...
// Use the SDK
const result = await client.documents.capabilities.retrieve();
```
...
```typescript
// GET /doc/v3/api/documents/capabilities
const result = await client.documents.capabilities.retrieve();
```
...
```typescript
import { SdkworkDocumentsOpenClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/documents-sdk';
